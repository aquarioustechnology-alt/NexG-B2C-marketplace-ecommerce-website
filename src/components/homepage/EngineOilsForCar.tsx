      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-[30%]">
            <h2 
              className="!text-white text-[32px] lg:text-[44px] font-black tracking-tighter leading-tight mb-6"
              style={{ color: 'white' }}
            >
              Engine Oils <br className="hidden lg:block" /> For Car
            </h2>
            ...
            <Link 
              href="/shop" 
              className="relative px-8 py-3.5 bg-brand-blue rounded-lg text-white font-bold text-[16px] inline-flex items-center gap-3 shadow-2xl group/btn transition-all duration-300 transform hover:-translate-y-1 overflow-hidden"
            >
...
export default EngineOilsForCar;
