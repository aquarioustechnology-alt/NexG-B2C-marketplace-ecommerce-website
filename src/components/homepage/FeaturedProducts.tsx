...
const products = [
  {
    id: 501,
    name: "NexG Premium 5W-30 Full Synthetic Car Engine Oil",
    category: "Synthetic",
    price: 1350,
    originalPrice: 1699,
    discount: "20% OFF",
  ...
  {
    id: 502,
    name: "NexG Advanced Performance 5W-40 Synthetic Oil",
    category: "Synthetic",
    price: 1450,
    originalPrice: 1850,
    discount: "21% OFF",
  ...
  {
    id: 509,
    name: "NexG Hybrid Specialized 0W-16 Engine Oil",
    category: "Hybrid",
    price: 1750,
    originalPrice: 2199,
    discount: "20% OFF",
  ...
  {
    id: 510,
    name: "NexG Truck Power 15W-40 Heavy Duty Oil",
    category: "Diesel",
    price: 3250,
    originalPrice: 3999,
    discount: "18% OFF",
  ...
  {
    id: 511,
    name: "NexG Moto Racing 10W-40 4T Synthetic Oil",
    category: "Motorcycle",
    price: 850,
    originalPrice: 1050,
    discount: "19% OFF",
  ...
  {
    id: 512,
    name: "NexG Scooter Guard 10W-30 4AT Oil",
    category: "Motorcycle",
    price: 450,
    originalPrice: 599,
    discount: "25% OFF",
  ...
  return (
    <section className="bg-white py-[60px]">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
        ...
        {/* 2-Row Static Grid */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-[24px] px-1">
          {products.map((product) => (
            <div 
              key={product.id} 
              className="group flex flex-col transition-all duration-500 bg-white"
            >
              ...
              <div className="px-1 py-5">
                ...
                <div className="flex items-center gap-3 mb-2.5">
                  <span className="text-[16px] xl:text-[18px] font-semibold text-brand-blue">
                    ₹{product.price.toLocaleString()}
                  </span>
                  <span className="text-[13px] xl:text-[14px] font-semibold text-brand-red line-through">
                ...
                <div className="flex flex-wrap items-center gap-2 mt-4">
                  {product.sizes.map((size) => (
                    <button 
                      ...
                      className={`px-3 py-1.5 border rounded-lg text-[10px] font-semibold uppercase transition-all cursor-pointer ${
